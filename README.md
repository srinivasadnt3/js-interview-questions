...
| No. | Questions |
|---- | ---------
|1  | [Symbols in js, UniqueValue-IdentifierToObjectProp->obj.id=..But id could already comming from backend and we have a chance to override it -Symbol(label), Symbol.for('sameKeywithLabel')=> used for meta data, will not print when iterating,](#Symbols-in-js) |
|2  | [methodCall(arg1,arg2) , function fn(par1,param2)](#Symbols-in-js) |
|3  | [Lexical Environment - Local memory +  lexical environment of the lexical parent](#Symbols-in-js) |
:
...
|5  | [What is the purpose of the array slice method **select(strtIdx, nIdx-1) Immutable**](#what-is-the-purpose-of-the-array-slice-method)|
|6  | [What is the purpose of the array splice method **add/remove (srtIdx,NumberOfItems)returns [..] / (srtIdx,NumI, 1,2,3)=> replaces items with provided array** Mutable](#what-is-the-purpose-of-the-array-splice-method)|
...
|11 | [What is a first class function **(treated as value)**](#what-is-a-first-class-function)|
|12 | [What is a first order function **no fnInput,fnOtput from function**](#what-is-a-first-order-function)|
|13 | [What is a higher order function unlike firstOrder **accept and return**](#what-is-a-higher-order-function)|
|14 | [What is a unary function - **aka monadic(singleArgument)**](#what-is-a-unary-function)|
